							...
							<div className="flex w-full p-12">
								<div className="w-1/2 pr-12">
									...
									<div className="border-b-1 border-gray-400 py-12 flex justify-between">
										...
										<Typography>{state.selectedTransaction.CouponId}</Typography>
									</div>
									<div className="border-b-1 border-gray-400 py-12 flex justify-between">
										<Typography>Coupon_Ticket ID:</Typography>
										<Typography> {state.selectedTransaction.Coupon_ticketId}</Typography>
									</div>
									<div className="border-b-1 border-gray-400 py-12 flex justify-between">
								...
								<div className="w-1/2 pl-12">
									<div className="border-b-1 border-gray-400 py-12 flex justify-between">
										...
										<Typography>${state.selectedTransaction.Discount}</Typography>
									</div>
									<div className="border-b-1 border-gray-400 py-12 flex justify-between">
										<Typography>Orginal Price:</Typography>
										<Typography> ${state.selectedTransaction.Original_price}</Typography>
									</div>
									<div className="border-b-1 border-gray-400 py-12 flex justify-between">
										<Typography>Price:</Typography>
										<Typography> ${state.selectedTransaction.Price}</Typography>
									</div>
									<div className="border-b-1 border-gray-400 py-12 flex justify-between">
										<Typography>Tax:</Typography>
										<Typography> ${state.selectedTransaction.Tax}</Typography>
									</div>
									<div className="border-b-1 border-gray-400 py-12 flex justify-between">
